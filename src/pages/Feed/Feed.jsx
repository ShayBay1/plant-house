...
export default function Feed({ user, handleLogout }) {
  ...
  async function handleAddPost(post) {
    try {
      ...
      console.log(
        data,
        " this is 'data' a response from the server, in handleAddPost"
      );
  ...
  async function deletePost(postId) {
    ...
    try {
      ...
      console.log(
        data,
        " this is 'data' a response from the server, in deletePost"
      );
      getPosts();
      setLoading(false);
    } catch (err) {
  ...
  async function addComment(postId) {
    try {
      ...
      console.log(
        data,
        "<--------response from the server when adding comment"
      );
    } catch (err) {
      console.log(err);
      setError(err.message);
